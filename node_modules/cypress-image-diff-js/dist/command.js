...
var compareSnapshotCommand = function compareSnapshotCommand(defaultScreenshotOptions) {
  ...
  Cypress.Commands.add('compareSnapshot', {
    ...
    var testName = "".concat(specName.replace('.js', '').replace('.ts', '')).concat(/^\//.test(name) ? '' : '-').concat(name);
    ...
    (0, _cypressRecurse.recurse)(function () {
      ...
      var screenshotted = objToOperateOn.screenshot(testName, defaultScreenshotOptions);
